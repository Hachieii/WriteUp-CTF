...
id: "Hoshino_Portal"
author: "phughj"
description: "Kẻ ngu nói về quá khứ, kẻ khôn nói về hiện tại, người thông minh nói về tương lai, người chơi mảng web không thể không làm bài này."
points: 50
difficulty: "Easy"
readTime: "6 min"
date: "15-12-2025"
...
- Nhưng nếu không thì cấu trúc của `newResetCode` lại rất đơn giản
  ...
  - **L**: các kí tự có mã ASCII từ 65 đến 65 + 6 _(vì hàm Math.random() trả giá trị trong đoạn [0, 1])_
